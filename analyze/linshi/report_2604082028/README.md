...
## 1. 指标与计算规则
- 目标级匹配：同类别一对一 Hungarian 匹配，IoS>=tp_iou 计为 TP。
  - IoS 定义：Intersection / min(area_gt, area_pred)。
...
## 5. 复现
- 结果目录：`/home/ubuntu/hpproject/yolo/analyze/result/report_2604082028`
- 运行时间：`2026-04-08T20:28:59`