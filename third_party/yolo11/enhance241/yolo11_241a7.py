...
def apply(model: Any, cfg: Any) -> Any:
    ...
    if any(bool(_deep_get(cfg, "enhance241", k, default=False)) for k in ("a3", "a5")):
        raise RuntimeError("enhance241.a7 conflicts with a3/a5; enable only one A-class module.")
