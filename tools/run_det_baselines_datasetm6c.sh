...
echo "[cfg] FRCNN_EPOCHS=${FRCNN_EPOCHS} FRCNN_BATCH=${FRCNN_BATCH} FRCNN_LR=${FRCNN_LR} FRCNN_PRETRAINED_COCO=${FRCNN_PRETRAINED_COCO}"
echo "[cfg] RTDETR_MODEL=${RTDETR_MODEL} RTDETR_EPOCHS=${RTDETR_EPOCHS} RTDETR_BATCH=${RTDETR_BATCH} RTDETR_PRETRAINED=${RTDETR_PRETRAINED}"
